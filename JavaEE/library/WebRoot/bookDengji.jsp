...
<div class="inner-block">
   ...
   <form  id="cahxun1" action="BookManageAction!BookDengji.action" method="post">
   <!--bagets-->
     <div class="typo-badges">
       <div class="appearance">
			 <h3 class="ghj">图书入库登记</h3>
				<div class="col-md-6">
					  <table class="table table-bordered">
						<tbody>
							<tr>
								<td>图书档案编号</td>
								<td><span class="badge">图书档案编号默认按流水号自增</span></td>
							</tr>
							<tr>
								<td>书名</td>
								<td><input name="bookName" value="" type="text"></td>
							</tr>
							<tr>
								<td>出版社名称</td>
								<td><input name="bookPublisherName" value="" type="text"></td>
							</tr>
							<tr>
								<td>作者名称</td>
								<td><input name="bookAuthorName"  value="" type="text"></td>
							</tr>
						</tbody>
					  </table>                    
				</div>
					<div class="col-md-6">
					  <table class="table table-bordered">
						<tbody>
							<tr>
								<td>入库时间</td>
								<td><input type="text" name="bookStorageTime"  class="w150" onclick="laydate({istime: true, format: 'YYYY-MM-DD '})" onfocus="this.blur()"></td>
							</tr>
							<tr>
								<td>类型(0：教育类，1：工商类，2：经济类)</td>
								<td><input name="bookType" value=""  type="text"></td>
							</tr>
							<tr>
								<td>图书价格</td>
								<td><input name="bookPric" value=""  type="text"></td>
							</tr>
							<tr>
								<td>存放位置</td>
								<td><input name="storageLocation" value=""  type="text"></td>
							</tr>
						</tbody>
					  </table>                    
				</div>
