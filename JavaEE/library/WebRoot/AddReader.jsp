...
<div class="inner-block">
   ...
   <form  id="cahxun1" action="ReaderMessageAction!Readerxinzneng.action" method="post">
   <!--bagets-->
     <div class="typo-badges">
       <div class="appearance">
			 <h3 class="ghj">新建图书证登记页</h3>
				<div class="col-md-6">
					  <table class="table table-bordered">
						<tbody>
							<tr>
								<td>图书证编号</td>
								<td><span class="badge">图书证编号默认按流水号自增</span></td>
							</tr>
							<tr>
								<td>学生姓名</td>
								<td><input name="xueshnegmingzi" value="" type="text"></td>
							</tr>
							<tr>
								<td>学号</td>
								<td><input name="xueshengxuehao" value="" type="text"></td>
							</tr>
					...
					<div class="col-md-6">
					  <table class="table table-bordered">
						<tbody>							
							<tr>
								<td>目前借阅的书</td>
								<td><input name="muqianjiedeshu" value=""  type="text"></td>
							</tr>
							<tr>
								<td>电话</td>
								<td><input name="xeushnegdianhua" value=""  type="text"></td>
							</tr>
							<tr>
								<td>性别(0:男，1：女，，只能输入这两个数，否则不予登记)</td>
								<td><input name="xueshengxingbie"  value="" type="text"></td>
							</tr>
						</tbody>
					  </table>                    
				</div>
