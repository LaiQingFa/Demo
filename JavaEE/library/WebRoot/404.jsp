    ...
    <div class="sidebar-menu">
		    ...
		    <div class="menu">
		      <ul id="menu" >
		        ...
		        <li id="menu-academico" ><a href="#"><i class="fa fa-file-text"></i><span>员工管理</span><span class="fa fa-angle-right" style="float: right"></span></a>
		         ...
		         <li><a href="#"><i class="fa fa-cog"></i><span>操作员管理</span><span class="fa fa-angle-right" style="float: right"></span></a>
		         	 <ul id="menu-academico-sub" >
