...
<form  id="xiugai" action="WorkerMnageAction!updateWorker.action" method="post">		
    ...
    <div class="blank">
      ...
      <table border="0" width="820" class="yujing_cc yjjl4_cc">
              ...
              <tr class="hang01">
                <td>员工档案编号</td>
                <td>姓名</td>
                <td>状态(0:超级管理员  1：员工   2禁用)</td>
                <td>电话</td> 
                 <td>密码</td>          
              </tr>
              <tr>
               <td><input type="text" name="operatorIdnum1"   value="${operatorIdnum1}" ></td>
               <td><input type="text" name="operatorName1" value="${operatorName1}" ></td>
               <td><input type="text" name="operatorState" value="${operatorState}" ></td>
               <td><input type="text" name="operatorPhone" value="${operatorPhone}" ></td>
               <td><input type="text" name="operatorPasscode" value="${operatorPasscode}" ></td>
                </tr>
