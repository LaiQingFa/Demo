...
<div class="inner-block">
    <div class="blank">
    	...
    	<form id="cahxun" action="ReaderMessageAction!searchReader.action" method="post" >
			<input type="text" name="bianhao" value=""  placeholder="Search..." required="">	
    	 ...
    	 <table class="table tab-border">
	                    <tbody>
	                        <tr class="unread checked">
	                            ...
	                            <td class="hidden-xs"> ${xueshnegbiao.xueshengbianhao}  </td>
	                            <td>
	                           ${xueshnegbiao.xueshnegmingzi}
	                             </td>
	                              <td>
                                ${xueshnegbiao.xueshengxuehao}
	                             </td>
	                              <td>
	                           
	                                  ${xueshnegbiao.muqianjiedeshu}
	                             </td>
	                            <td>
	                               ${xueshnegbiao.xueshengxingbie}
	                             </td>
	                            <td>
	                            ${xueshnegbiao.xeushnegdianhua}
	                            </td>
	                        </tr>
