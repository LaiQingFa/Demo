...
<form id="cahxun1" action="BorrowMessageAction!BorrowMessageDengjiINdex1.action" method="post">		
        	...
        	<div class="blankpage-main">	
    			 <table class="table table-bordered">
						<tbody>
							<tr>
								<td>借阅编号</td>
								<td><span class="badge">借阅编号默认按流水号自增</span></td>
							</tr>
							<tr>
								<td>图书条形码</td>
								<td><input name="jieyuedetushubianhao" value="" type="text"></td>
							</tr>
							<tr>
								<td>借阅人图书证编码</td>
								<td><input  name="duzhebianhao" value="" type="text"></td>
							</tr>
							<tr>
								<td>借阅时间</td>
								<td><input type="text" name="jieyuedeshijian"  class="w150" onclick="laydate({istime: true, format: 'YYYY-MM-DD '})" onfocus="this.blur()"></td>
							</tr>
